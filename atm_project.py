...
while True:
    ...
    if command == 'Bank Transfer':
        ...
        if selection2 == '1':
            ...
            account_balance = 100000000
            available_balance = account_balance - Transfer_amount
    ...
    if command == 'Paybills':
        ...
        if selection4 == 'd':
            ...
            if selection12 == 'd':
                ...
                selection14 = selection14.strip().lower()
    ...
    if command == "Finish":
        ...
        time.sleep(4)
        print(f"Thank you for banking with us Mr/Mrs/Miss {user}")
